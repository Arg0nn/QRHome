...
<div class="intro intro-carousel">
    <div id="carousel" class="owl-carousel owl-theme">
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(<?php echo base_url('assets/img/teste.jpg')?>">
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">São Paulo, SP
                      <br> 02832-190</p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">11348 </span> Consolação
                      <br> Avenida Paulista</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">ALUGUE | R$ 16.140</span></a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">ALUGUE | R$ 12.000</span></a>
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            <div class="title-box">
              <h2 class="title-a">Últimos adicionados</h2>
            </div>
            <div class="title-link">
              <a href="<?php echo site_url('imoveis') ?>">Todas os Imóveis
                <span class="ion-ios-arrow-forward"></span>
              </a>
            </div>
          </div>
              ...
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">ALUGUE | R$ 12.000</span>
                  </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="<?php echo base_url('assets/img/agent-4.jpg')?>" alt="" class="img-d img-fluid">
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="<?php echo base_url('assets/img/agent-1.jpg')?>" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
        ...
        <div class="col-md-4">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="<?php echo base_url('assets/img/agent-5.jpg')?>" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            <div class="title-box">
              <h2 class="title-a">Últimas Notícias</h2>
            </div>
            <div class="title-link">
              <a href="blog-grid.html">Todas as Notícias
                <span class="ion-ios-arrow-forward"></span>
              </a>
            </div>
          </div>
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-category-b">
                  <a href="#" class="category-b">Casas</a>
                </div>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-img">
                  <img src="<?php echo base_url('assets/img/testimonial-1.jpg')?>" alt="" class="img-fluid">
                </div>
              </div>
              <div class="col-sm-12 col-md-6">
                ...
                <div class="testimonial-author-box">
                  <img src="<?php echo base_url('assets/img//mini-testimonial-1.jpg')?>" alt="" class="testimonial-avatar">
        ...
        <div class="carousel-item-a">
          <div class="testimonials-box">
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-img">
                  <img src="<?php echo base_url('assets/img/testimonial-2.jpg')?>" alt="" class="img-fluid">
                </div>
              </div>
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-ico">
                ...
                <div class="testimonial-author-box">
                  <img src="<?php echo base_url('assets/img/mini-testimonial-2.jpg')?>" alt="" class="testimonial-avatar">
