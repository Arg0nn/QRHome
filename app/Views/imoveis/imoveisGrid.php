      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Nossos Incríveis Imóveis</h1>
            <span class="color-text-a">Imóveis</span>
          </div>
        </div>
          ...
          <div class="grid-option">
            <form>
              <select class="custom-select">
                ...
                <option value="1">Ordenar por preço</option>
                <option value="2">Para alugar</option>
                <option value="3">Para comprar</option>
              </select>
            </form>
          </div>
        </div>
